...
| certified | 5 |
| candidate | 79 |
| 学科 | 7(Biology 8,Chemistry 13,ComputerScience 8,EarthScience 7,Engineering 13,Mathematics 19,Physics 16) |
...
| 任务 | 学科 | 领域 | 打分 | oracle | 认证 | 说明 | 中文题意 | 中文评估方法 |
|---|---|---|---|---|---|---|---|---|
| [`AffineLoopRankingCertificate`](benchmarks/ComputerScience/AffineLoopRankingCertificate/)<br>仿射循环线性秩函数证书 | ComputerScience | ScientificComputing | clipped | analytical | candidate | prove a loop ranks, do not just run it | 为已公布的 8–16 维耦合有理仿射 while 循环提交精确有理线性秩函数与 Farkas 乘子,证明守卫多面体上的均匀下降 | 扣除基线后相对每实例精确 LP 最优下降量的均值;均匀小步长基线恰为零,浮点 LP 直接判零,不是连续 Lyapunov |
