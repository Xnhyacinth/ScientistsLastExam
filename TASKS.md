...
| certified | 5 |
| candidate | 81 |
| 学科 | 7(Biology 9,Chemistry 13,ComputerScience 7,EarthScience 8,Engineering 13,Mathematics 19,Physics 17) |
...
| [`GlenFlowLawDiscovery`](benchmarks/EarthScience/GlenFlowLawDiscovery/)<br>冰川 Glen 流变律发现 | EarthScience | Glaciology | clipped | physical_sim | candidate | This reduced creep model is | 在 12 次应力和温度测定下联合恢复 Glen、Newtonian 或 GBS 指数、幅度和热响应;滑动混合、塞流或应力依赖 n 须拒答 | 三族粘性律恢复 + 滑动/塞流/变指数拒答;两窗口参考不解 GBS |
