...
| certified | 5 |
| candidate | 83 |
| 学科 | 7(Biology 9,Chemistry 15,ComputerScience 8,EarthScience 7,Engineering 13,Mathematics 19,Physics 17) |
...
| [`UnimolecularFalloffLaw`](benchmarks/Chemistry/UnimolecularFalloffLaw/)<br>单分子降压律 | Chemistry | ChemicalKinetics | clipped | physical_sim | candidate | Lindemann or Troe, or neither | 在有限次 (T,P) 测定下区分 Lindemann 与 Troe 降压,并恢复 300 K 的 k_inf 与 Pr;双通道或负压阶须拒答 | 机制恢复 + 双通道/负压阶拒答;不是反应网络辨识,也不是酶动力学 |
