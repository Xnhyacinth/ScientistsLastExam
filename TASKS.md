...
| certified | 5 |
| candidate | 83 |
| 学科 | 7(Biology 9,Chemistry 13,ComputerScience 10,EarthScience 7,Engineering 13,Mathematics 19,Physics 17) |
...
| 任务 | 学科 | 领域 | 打分 | oracle | 认证 | 说明 | 中文题意 | 中文评估方法 |
|---|---|---|---|---|---|---|---|---|
| [`AffineLoopRankingCertificate`](benchmarks/ComputerScience/AffineLoopRankingCertificate/)<br>仿射循环词典序秩函数证书 | ComputerScience | ScientificComputing | clipped | analytical | candidate | prove a nested loop ranks, do not just run it | 为已公布的嵌套复位有理仿射循环提交精确有理词典序秩函数元组与 Farkas 乘子,单条线性秩函数不完备 | 扣除基线后相对每实例已验证嵌套词典序质量的均值;1-ranking Farkas LP 不可行,均匀小步长基线恰为零,浮点直接判零 |
