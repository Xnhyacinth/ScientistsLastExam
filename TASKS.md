...
| [`LyapunovDecayCertificate`](benchmarks/Engineering/LyapunovDecayCertificate/)<br>切换系统 Lyapunov 衰减证书 | Engineering | ControlTheory | clipped | analytical | candidate | prove a decay rate, do not just simulate one | 为已公布的切换线性系统提交精确有理共同二次 Lyapunov 证书,证明与切换信号无关的衰减率 | 所证 alpha 减 1/10000 后相对 3/4 裁剪单位的均值;单位阵小速率基线恰为零,浮点 LMI 直接判零 |
