...
| certified | 5 |
| candidate | 84 |
| 学科 | 7(Biology 9,Chemistry 15,ComputerScience 9,EarthScience 7,Engineering 13,Mathematics 19,Physics 17) |
...
| [`DiblockMorphologyDiscovery`](benchmarks/Chemistry/DiblockMorphologyDiscovery/)<br>双嵌段形貌发现 | Chemistry | PolymerScience | clipped | physical_sim | candidate | lamellae, hex, bcc, gyroid, or refuse | 从预算内一维 SAXS 认出双嵌段熔体的层状/六方/BCC/螺旋或无序;两套 q* 的混合物或 ABC 三嵌段须拒答 | 形貌恢复 + 非平衡混合拒答;不是二元 XRD 相图,也不是分子谱指认 |
