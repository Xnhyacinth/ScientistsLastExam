...
| [`GlenFlowLawDiscovery`](benchmarks/EarthScience/GlenFlowLawDiscovery/)<br>冰川 Glen 流变律发现 | EarthScience | Glaciology | clipped | physical_sim | candidate | This reduced creep model is | 在 12 次应力和温度测定下联合恢复 Glen 连续指数、幅度和热响应;可辨滑动混合或塞流须拒答 | 联合参数恢复 + 滑动/塞流拒答;当前参考约 0.96,难度门未过 |
